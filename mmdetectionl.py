...
def detection(num, score_thr):
    ...
    img = f'upload/{num}.png'
    img_out = f'upload/{num}.out.png'
    data_out = f'upload/{num}.out.json'
    ...
    img = model.show_result(img, result, score_thr=score_thr, thickness=1, show=False, out_file=img_out, text_color='red', bbox_color='green')
